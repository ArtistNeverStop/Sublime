...
class DepartmentsConnectionQuery extends Query
{
    /**
     ...
     * @var string
     */
    public static $name = 'departmentsConnection';
     ...
     * @var string
     */
    public static $description = 'Paginate all the Departments.';
    ...
    {
        // return dd(static::makeQuery(Department::class, [], $info, static::METHOD_MULTIPLE));
        return Department::paginate($args['first'], ['*'], 'page', isset($args['page']) ? $args['page'] : null);
    }
