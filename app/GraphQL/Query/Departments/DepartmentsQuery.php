...
class DepartmentsQuery extends Query
{
     ...
     * @var string
     */
    public static $name = 'departments';
     ...
     * @var string
     */
    public static $description = 'Retrive all the Departments.';
    ...
    {
        return static::makeQuery(Department::class, $args, $info, static::METHOD_MULTIPLE);
    }
    ...
    public function arguments()
    {
        return [
            'name' => [
                'description' => 'The name to match on Departments',
                'type' => Type::string()
            ]
        ];
    }
    ...
    {
        return Type::nonNull(Type::listOf(Type::department()));
    }
}
