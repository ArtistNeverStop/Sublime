...
class ProductsConnectionQuery extends Query
{
    /**
     ...
     * @var string
     */
    public static $name = 'productsConnection';
     ...
     * @var string
     */
    public static $description = 'Paginate all the Products.';
    ...
    {
        return Product::paginate($args['first'], ['*'], 'page', isset($args['page']) ? $args['page'] : null);
    }
